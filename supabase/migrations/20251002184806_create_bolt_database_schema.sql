/*
  # BoltDatabase - Estructura Completa (Sin Datos)
  
  Esta migración crea una nueva base de datos con la misma estructura que la aplicación
  actual, pero sin transferir ningún dato existente.
  ...
  ## Importante
  Esta migración NO copia datos de ninguna base de datos existente.
  Solo crea la estructura vacía lista para usar.
*/
